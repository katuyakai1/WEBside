...
<div id="head">
	...
	<div id="title">
		<h1>
			孫 in the sky! <br>どこにも現れる孫に<br>元気を貰おう！
		</h1>
		<h2>
			いつまでも元気な体と発想を。<br>体を使って孫と一緒に<br>空に絵を描くことで<br>エクササイズ！<br>新感覚ア―トで心と体を鍛えよう！<br />
			<br />H440
		</h2>
	</div>
</div>
...
<body>
	...
	<div id="topBox">
		...
		<!-- ローカルリンク -->
		<a href="http://localhost/GP41/mago/smph/index.php">ギャラリーを見る( *^艸^)</a>
	</div>
	<div id="mainBox">
	...
	if (file_get_contents ( '../ranking.txt', true )) {
		...
		foreach ( $data as $dat ) {
			...
			echo "<tr><td width=20%>" . $i . "位</td>";
			echo "<td width=40%>" . $substr1 . "</td>";
			echo "<td width=40%>" . $substr2 . "pt!</td></tr>";
			$i ++;
		}
